...
const HOODS = {
  hoodOakHill: { cx: 290, cy: 70, rx: 56, ry: 34, label: 'Oak Hill' },
  hoodBartonCreek: { cx: 200, cy: 96, rx: 58, ry: 36, label: 'Barton Creek' },
  hoodAustin: { cx: 230, cy: 205, rx: 78, ry: 56, label: 'Central Austin', big: true },
